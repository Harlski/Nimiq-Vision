...
export default class Identicons {
    ...
    static placeholder(color = '#bbb', strokeWidth = 1) {
        return `<svg viewBox="0 0 125 125" width="125" height="125" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink" >
...
${await this._generatePart('bottom', bottomNr)}
    ...
    static _$svg(content) { // eslint-disable-line no-unused-vars
        ...
        return `<svg viewBox="0 0 160 160" width="125" height="125" xmlns="http://www.w3.org/2000/svg" style="margin-top: 25px;">
